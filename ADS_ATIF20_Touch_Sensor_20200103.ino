...
// -----------------------------------------------------------------------
   ...
   //Change the value of the register 0x10j when a problem occurs due to voltage drop
   ...
   Wire.write(byte(0xC0)); // data (Sense Freq. Low. 0x40 = Freq. High)
   Wire.endTransmission(); // 
